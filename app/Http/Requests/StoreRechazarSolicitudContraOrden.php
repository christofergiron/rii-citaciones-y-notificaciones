...
class StoreRechazarSolicitudContraOrden //extends FormRequest
{
    ...
    public function rules($arr)
    {
       ...
       $validator = Validator::make($arr   , [
         ...
         "solicitud_contra_orden_captura.fecha_rechazo" => "required",
         "solicitud_contra_orden_captura.razon_rechazo" => "required"
       ]);
    ...
    public function set_solicitud($arr) {
      ...
      $solicitud->fecha_rechazo = $arr["solicitud_contra_orden_captura"]["fecha_rechazo"];
      $solicitud->razon_rechazo = $arr["solicitud_contra_orden_captura"]["razon_rechazo"];
