...
class StoreAceptarSolicitudOrden //extends FormRequest
{
    ...
    public function rules($arr)
    {
       ...
       $validator = Validator::make($arr   , [
         ...
         "solicitud_orden_captura.fecha_aprovacion" => "required",
         "solicitud_orden_captura.id_orden_captura" => "required"
       ]);
