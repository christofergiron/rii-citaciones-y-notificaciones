...
class StoreInformeEscenaDelitoSS //extends FormRequest
{
    ...
    public function rules($arr)
    {
       $validator = Validator::make($arr   , [
        ...
        "informe_escena_delito_ss.informe.descripcion" => "nullable",

        "informe_escena_delito_ss.procesos_investigativos" => "required|array|min:1",
        "informe_escena_delito_ss.procesos_investigativos.*.nombre" => "required",
        "informe_escena_delito_ss.procesos_investigativos.*.descripcion" => "required",
        "informe_escena_delito_ss.procesos_investigativos.*.fecha_inicio" => "required|date_format:Y/m/d",
        "informe_escena_delito_ss.procesos_investigativos.*.fecha_fin" => "required|date_format:Y/m/d"
     ]);
    ...
    public function set_informe($arr) {
      //Solicitud Hijo
        $informe_escena_delito_ss_arr = [
          "workflow_state" => "nueva_denuncia",
        ];
        $informe_escena_delito_ss = InformeEscenaDelitoSS::create($informe_escena_delito_ss_arr);
      //Solicitud Padre
        $informe_arr = [
          ...
          "descripcion" => $arr["informe_escena_delito_ss"]["informe"]["descripcion"]
        ];
      ...
      //Anexo
        ...
        return $informe_escena_delito_ss;
    }
