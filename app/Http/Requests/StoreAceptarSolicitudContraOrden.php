...
class StoreAceptarSolicitudContraOrden //extends FormRequest
{
    ...
    public function rules($arr)
    {
       ...
       $validator = Validator::make($arr   , [
         ...
         "solicitud_contra_orden_captura.id_solicitud" => "required",
         "solicitud_contra_orden_captura.fecha_aprovacion" => "required",
         "solicitud_contra_orden_captura.id_contra_orden" => "required"
       ]);
    ...
    public function set_solicitud($arr) {
      ...
      $solicitud = SolicitudContraOrden::find($arr["solicitud_contra_orden_captura"]["id_solicitud"]);

      $solicitud->id_contra_orden = $arr["solicitud_contra_orden_captura"]["id_contra_orden"];
      $solicitud->fecha_aprovacion = $arr["solicitud_contra_orden_captura"]["fecha_aprovacion"];
