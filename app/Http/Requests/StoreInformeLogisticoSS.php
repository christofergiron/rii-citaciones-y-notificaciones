...
class StoreInformeLogisticoSS //extends FormRequest
{
    ...
    public function rules($arr)
    {
       $validator = Validator::make($arr   , [
        ...
        "informe_logistico_ss.informe.solicitado_por" => "required",
        "informe_logistico_ss.informe.descripcion" => "nullable",

        "informe_logistico_ss.procesos_investigativos" => "required|array|min:1",
        "informe_logistico_ss.procesos_investigativos.*.nombre" => "required",
        "informe_logistico_ss.procesos_investigativos.*.descripcion" => "required",
        "informe_logistico_ss.procesos_investigativos.*.fecha_inicio" => "required|date_format:Y/m/d",
        "informe_logistico_ss.procesos_investigativos.*.fecha_fin" => "required|date_format:Y/m/d"
     ]);
    ...
    public function set_informe($arr) {
      //Solicitud Hijo
        $informe_logistico_ss_arr = [
          "workflow_state" => "nueva_solicitud",
        ];
        $informe_logistico_ss = InformeLogisticoSS::create($informe_logistico_ss_arr);
      //Solicitud Padre
        $informe_arr = [
          ...
          "solicitado_por" => $arr["informe_logistico_ss"]["informe"]["solicitado_por"],
          "descripcion" => $arr["informe_logistico_ss"]["informe"]["descripcion"]
        ];
        $informe = new Informe($informe_arr);
        $informe_logistico_ss->informe()->save($informe);
      //Anexo
        $anexos_arr = [
        ...
        $_arr = [];
        foreach($arr["informe_logistico_ss"]["procesos_investigativos"] as $d) {
            $hitos_arr = [
                "nombre" => $d["nombre"],
