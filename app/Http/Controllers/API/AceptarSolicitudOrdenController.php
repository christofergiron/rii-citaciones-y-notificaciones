...
use Validator;
use App\Http\Requests\StoreAceptarSolicitudOrden;

class AceptarSolicitudOrdenController extends Controller
{
    ...
    public function __construct(LoggerInterface $logger)
    {
        ...
        $this->logger = $logger;
        $this->root = false;
        $this->StoreSolicitud = new StoreAceptarSolicitudOrden;
    }
