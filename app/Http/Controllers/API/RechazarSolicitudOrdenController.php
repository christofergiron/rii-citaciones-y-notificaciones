...
use Validator;
use App\Http\Requests\StoreRechazarSolicitudOrden;

class RechazarSolicitudOrdenController extends Controller
{
    ...
    public function __construct(LoggerInterface $logger)
    {
        ...
        $this->logger = $logger;
        $this->root = false;
        $this->StoreSolicitud = new StoreRechazarSolicitudOrden;
    }
