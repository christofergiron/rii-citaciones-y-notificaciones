...
use App\Http\Requests\StoreSospechosoInvestigacionSSInforme;
...
class SospechosoInvestigacionSSInformeController extends Controller
{
    ...
    public function __construct(LoggerInterface $logger)
    {
        ...
        $this->root = false;
        $this->StoreSospechosoInvestigacionSS = new StoreSospechosoInvestigacionSSInforme;
    }
    ...
    public function store(Request $request) {
      ...
      $this->logger->alert('inside Store Sospechoso Investigacion Informe');
