...
class BuscarOrdenCapturaPersonaController extends Controller
{
    ...
    public function show_persona(Request $request, $id) {
      # parsing
      $arr = $request->all();
      $this->log::alert($arr);
       ...
       #get orden captura
       $res = $this->orden_captura_tools->buscar_orden_captura_persona($id, $arr["token"]);
