...
use App\SolicitudContraOrdenTools;
use App\Fiscal;
...
use Validator;
use App\Http\Requests\StoreSolicitudContraOrden;

class SolicitudContraOrdenController extends Controller
{
    ...
    public function __construct(LoggerInterface $logger)
    {
        ...
        $this->solicitud_tools = new SolicitudContraOrdenTools;
        $this->root = false;
        $this->StoreSolicitud = new StoreSolicitudContraOrden;
    }
