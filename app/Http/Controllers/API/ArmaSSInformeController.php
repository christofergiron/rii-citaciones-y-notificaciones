...
use App\ArmaSS;
use App\ArmaSSTools;
use App\Http\Requests\StoreArmaSSInforme;
...
class ArmaSSInformeController extends Controller
{
    ...
    public function __construct(LoggerInterface $logger)
    {
        ...
        $this->root = false;
        $this->StoreArmaSS = new StoreArmaSSInforme;
    }
    ...
    public function store(Request $request) {
      ...
      $this->logger->alert('inside Store Arma Informe');
